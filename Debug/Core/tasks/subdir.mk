...
clean-Core-2f-tasks:
	-$(RM) ./Core/tasks/display_task.cyclo ./Core/tasks/display_task.d ./Core/tasks/display_task.o ./Core/tasks/display_task.su ./Core/tasks/keypad_task.cyclo ./Core/tasks/keypad_task.d ./Core/tasks/keypad_task.o ./Core/tasks/keypad_task.su ./Core/tasks/lock_task.cyclo ./Core/tasks/lock_task.d ./Core/tasks/lock_task.o ./Core/tasks/lock_task.su ./Core/tasks/sd_task.cyclo ./Core/tasks/sd_task.d ./Core/tasks/sd_task.o ./Core/tasks/sd_task.su
