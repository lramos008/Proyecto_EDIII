...
C_SRCS += \
../Core/subsystems/voice_capture/voice_capture.c 

OBJS += \
./Core/subsystems/voice_capture/voice_capture.o 

C_DEPS += \
./Core/subsystems/voice_capture/voice_capture.d 


# Each subdirectory must supply rules for building sources it contributes
Core/subsystems/voice_capture/%.o Core/subsystems/voice_capture/%.su Core/subsystems/voice_capture/%.cyclo: ../Core/subsystems/voice_capture/%.c Core/subsystems/voice_capture/subdir.mk
...
clean: clean-Core-2f-subsystems-2f-voice_capture

clean-Core-2f-subsystems-2f-voice_capture:
	-$(RM) ./Core/subsystems/voice_capture/voice_capture.cyclo ./Core/subsystems/voice_capture/voice_capture.d ./Core/subsystems/voice_capture/voice_capture.o ./Core/subsystems/voice_capture/voice_capture.su

.PHONY: clean-Core-2f-subsystems-2f-voice_capture
