...
C_SRCS += \
../Core/subsystems/processing/fft_calculation.c \
../Core/subsystems/processing/filtering.c \
../Core/subsystems/processing/windowing.c 

OBJS += \
./Core/subsystems/processing/fft_calculation.o \
./Core/subsystems/processing/filtering.o \
./Core/subsystems/processing/windowing.o 

C_DEPS += \
./Core/subsystems/processing/fft_calculation.d \
./Core/subsystems/processing/filtering.d \
./Core/subsystems/processing/windowing.d 
...
clean-Core-2f-subsystems-2f-processing:
	-$(RM) ./Core/subsystems/processing/fft_calculation.cyclo ./Core/subsystems/processing/fft_calculation.d ./Core/subsystems/processing/fft_calculation.o ./Core/subsystems/processing/fft_calculation.su ./Core/subsystems/processing/filtering.cyclo ./Core/subsystems/processing/filtering.d ./Core/subsystems/processing/filtering.o ./Core/subsystems/processing/filtering.su ./Core/subsystems/processing/windowing.cyclo ./Core/subsystems/processing/windowing.d ./Core/subsystems/processing/windowing.o ./Core/subsystems/processing/windowing.su
